...
import { AddTaskPortal } from '../misc/AddTaskPortal.js';
    ...
    handle_mouse_up(e) {
        ...
        if (
            ...
            if (
                ...
                const position_style = get_mouse_position_style(
                    e.pageX,
                    e.pageY
                );
            ...
            if (current_priority !== parseInt(priority)) {
                result.push({
                    ...
                    action: () => {
                        ...
                        this.props.email.email.user_priority = parseInt(
                            priority
                        );
                        //re-render
                        this.setState({});
                ...
                <div
                    ...
                    onMouseUpCapture={
                        this.props.of_center_email
                            ? (e) =>
                                  this.setState({
                                      add_task_icon: this.handle_mouse_up(e),
                                  })
                            : null
                    }
                >
